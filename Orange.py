...
ADAFRUIT_IO_USERNAME = os.environ.get("ADAFRUIT_IO_USERNAME_Orange_Apple_Bellpepper")
ADAFRUIT_IO_KEY = os.environ.get("ADAFRUIT_IO_KEY_Orange_Apple_Bellpepper")
...
# === Sample ID ===
sample_id = "orange8"  # <-- Change this for each banana (banana1, banana2, etc.)

print("Starting sensor loop for", sample_id)

# === NIR Read Timer Setup ===
last_nir_time = time.time()
nir_interval = 300  # 5 minutes in seconds
