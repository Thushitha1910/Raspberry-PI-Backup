...
ADAFRUIT_IO_USERNAME = os.environ.get("ADAFRUIT_IO_USERNAME_Avacado")
ADAFRUIT_IO_KEY = os.environ.get("ADAFRUIT_IO_KEY_Avacado")
...
# === Sample ID ===
sample_id = "avacado1"  # <-- Change this for each banana (banana1, banana2, etc.)
