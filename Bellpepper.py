...
ADAFRUIT_IO_USERNAME2 = os.environ.get("ADAFRUIT_IO_USERNAME_Potato_Bellpepper_Tomato")
ADAFRUIT_IO_KEY2 = os.environ.get("ADAFRUIT_IO_KEY_Potato_Bellpepper_Tomato")


# === Initialize Adafruit IO Client ===
aio1 = Client(ADAFRUIT_IO_USERNAME1, ADAFRUIT_IO_KEY1)
aio2 = Client(ADAFRUIT_IO_USERNAME2, ADAFRUIT_IO_KEY2)
...
# === Sample ID ===
sample_id = "bellpepper2"  # <-- Change this for each banana (banana1, banana2, etc.)
...
while True:
    try:
        ...
        aio2.send('tgs2602-gas-bellpepper', f"{sample_id}:{tgs2602_voltage}")
